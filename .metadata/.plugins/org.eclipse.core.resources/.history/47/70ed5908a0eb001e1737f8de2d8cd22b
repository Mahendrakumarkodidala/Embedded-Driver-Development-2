...
volatile uint32_t pulse1_value = 25000; // 500Hz
volatile uint32_t pulse2_value = 12500; // 1000HZ
volatile uint32_t pulse3_value = 6250;  // 2000Hz
volatile uint32_t pulse4_value = 3125;  // 4000Hz
